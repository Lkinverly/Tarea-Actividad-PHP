...
<body>
    ...
    <div class="container">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_empleados">
            Nuevo Registro
        </button>
        <!-- Modal -->
        <div class="modal fade" id="modal_empleados" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                        ...
                        <form class="d-flex" action="crud_empleado.php" method="POST">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txt_id" id="txt_id" class="form-control" placeholder="0"
                                        value="0" readonly />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txt_direccion" id="txt_direccion" class="form-control"
                                        placeholder="Zona - Calle - Avenida" />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-lg" name="drop_puesto" id="drop_puesto">
                                        <option selected disabled>Elija un puesto</option>
                                        <?php
                            include("datos_conexion.php");
                            // Conexión
                            $db_conexion = mysqli_connect ($db_host, $db_usr, $db_pass, $db_nombre);
                            if ($db_conexion->real_query) {
                                die("Error de conexión: " . $db_conexion->real_query);
                            }
                            // Consulta puestos
                            ...
                            ?>
                                ...
                                <div class="mb-3">
                                    <input type="submit" name="btn_agregar" id="btn_agregar" class="btn btn-primary"
                                        value="Agregar">
                                    <input type="submit" name="btn_modificar" id="btn_modificar" class="btn btn-success"
                                        value="Modificar">
                                    <input type="submit" name="btn_eliminar" id="btn_eliminar" class="btn btn-danger"
                                        ...
                                        value="Eliminar">
                                    <input type="submit" name="btn_nuevo" id="btn_nuevo" class="btn btn-secondary"
                                        onclick="limpiar()" value="Nuevo">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="table-responsive mt-4">
            <table class="table table-hover table-primary align-middle">
                ...
                <tbody id="tbl_empleados" class="table-group-divider">
                    <?php
                        // Consulta empleados con su puesto
                        $sql = "SELECT e.id_empleado as id, e.codigo, e.nombres, e.apellidos, e.direccion, e.telefono, e.fecha_nacimiento, p.puesto, p.id_puesto 
                                FROM empleados AS e
